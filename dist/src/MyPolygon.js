...
var cl = __importStar(require("js-clipper"));
var lodash_1 = __importDefault(require("lodash"));
var JSC = __importStar(require("./JSClipperHelper"));
var PGN = __importStar(require("./polygonNamespace"));
var roundCorners_1 = require("./roundCorners");
var MyPolygon = /** @class */ (function () {
    ...
    MyPolygon.prototype.offsetOne = function (ammount, JoinType) {
        return this.offset(ammount, JoinType)[0];
    };
    ...
    MyPolygon.prototype.round = function (ammount) {
        var inPath = 'M' + this.polygon.join('L') + 'Z';
        return roundCorners_1.roundPathCorners(inPath, ammount, false);
    };
