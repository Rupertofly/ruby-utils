...
const JSC = __importStar(require("./JSClipperHelper"));
const PGN = __importStar(require("./polygonNamespace"));
class MyPolygon {
    constructor(polygon, contour) {
        ...
        else if (polygon.length != undefined) {
